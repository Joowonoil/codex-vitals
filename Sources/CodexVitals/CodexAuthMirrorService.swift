...
final class CodexAuthMirrorService: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "CodexVitals.CodexAuthMirror")
    ...
    private func fileSignature() -> FileSignature? {
        ...
        return FileSignature(modified: modified, size: size.int64Value, hash: data.codexVitalsSHA256)
    }
